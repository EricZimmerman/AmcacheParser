...
namespace AmcacheParser.Classes
{
    internal class ProgramsEntry
    {
        ...
        public ProgramsEntry(string programName, string programVer, string vendorName, string langCode, string installSource, string uninstallRegKey, string guid10, string guid12, string uninstallGuid11, int unknownD5, int unknownD13, int unknownD14, int unknownD15, byte[] unknown16,
            long unknownQ17, int unknownD18, DateTimeOffset installA, DateTimeOffset installB,string pathList,string uninstallGuidf, string rawFilesList,string programID, DateTimeOffset lastwrite )
        {
